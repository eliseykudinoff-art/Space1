"""
LifeAwareOrchestrator — P0 integration without rewriting core.py.

- Empty queue → IDLE_TICK (homeostasis + monitor heartbeat)
- SUCCESS / compliance / quality → emit events into pulse
- Legacy HomeostaticRegulator inside base Orchestrator unchanged
"""
...
class Orchestrator(_BaseOrchestrator):
    """Drop-in replacement for core.Orchestrator with life support."""
    ...
    def dispatch_full_cycle(self, mission_profile: str = "BALANCED") -> Dict[str, Any]:
        # Peek without consuming: list_queue is non-destructive
