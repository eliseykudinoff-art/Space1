...
class PeriodicHealthMonitor:
    ...
    BUG-001 FIX: Добавлено корректное управление asyncio.Task lifecycle.
    Теперь используется try/finally для гарантированной очистки.
    """
    ...
    async def stop(self):
        """Останавливает мониторинг с гарантированной очисткой."""
        ...
        if self._task:
            ...
            try:
                ...
                logger.warning("🏥 Health monitor task did not cancel in time")
            except Exception as e:
    ...
    async def _monitor_loop(self):
        ...
        try:
            ...
            # Ловим cancel и корректно выходим
